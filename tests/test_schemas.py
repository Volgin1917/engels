...
from backend.src.schemas import EntityCreate, ExtractionResult, RelationCreate
...
class TestEntitySchemas:
    ...
    def test_entity_create_minimal(self):
        ...
        entity = EntityCreate(name="Historical Event", entity_type="event")
...
class TestRelationSchemas:
    ...
    def test_relation_mcp_flag(self):
        ...
        relation = RelationCreate(subject_id=1, object_id=2, predicate="caused_by", source_mcp=True)
        assert relation.source_mcp is True

    def test_relation_default_values(self):
        """Test relation default values."""
        relation = RelationCreate(subject_id=1, object_id=2, predicate="part_of")
...
class TestExtractionResult:
    ...
    def test_extraction_result_with_data(self):
        ...
        relation = RelationCreate(subject_id=1, object_id=2, predicate="relates_to")
        result = ExtractionResult(entities=[entity], relations=[relation], confidence_score=0.75)
